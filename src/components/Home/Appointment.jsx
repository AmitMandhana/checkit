...
function DoctorAppointment() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    axios.get('https://amit19-1.onrender.com/api/patients2')
      .then(response => {
  ...
  const fetchDoctorDetails = (doctorName) => {
    axios.get(`https://amit19-1.onrender.com/api/doctor-details?name=${encodeURIComponent(doctorName)}`)
      .then(response => {
  ...
  const handleSubmitAppointment = (e) => {
    ...
    if (
      ...
      axios.post('https://amit19-1.onrender.com/api/patients', {
        ...patientDetails,
