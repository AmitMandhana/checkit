...
function Clinic() {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        const response = await axios.post("https://amit19-1.onrender.com/api/doctordata3");
  ...
  const handleClinicClick = async (clinic) => {
    try {
      ...
      await axios.post("https://amit19-1.onrender.com/api/location", { location: clinic.location });
