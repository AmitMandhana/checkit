...
function DoctorInterface() {
  ...
  const handleCheckIn = async () => {
    try {
      const response = await axios.post('https://amit19-1.onrender.com/api/doctor-times/check-in', { doctorId: 'doctor-id-here' });
  ...
  const handleCheckOut = async () => {
    try {
      const response = await axios.post('https://amit19-1.onrender.com/api/doctor-times/check-out', { doctorId: 'doctor-id-here' });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://amit19-1.onrender.com/api/prescription', formData);
