...
function ClinicAppointment() {
  ...
  useEffect(() => {
    ...
    if (storedClinicLocation) {
      axios.post("https://amit19-1.onrender.com/api/clinic-details", { location: storedClinicLocation })
        .then(response => {
    ...
    axios.post('https://amit19-1.onrender.com/api/doctordata4')
      .then(response => {
  ...
  const buyFunction = async () => {
    try {
      const response = await axios.post('https://amit19-1.onrender.com/api/payment');
